package com.siapaberani.kuis.Utils;
...
public class Config {
    ...
    public static final int QUESTION_COUNTDOWN_TIME = 10; // Countdown Time(In seconds)
    ...
    public static final int QUICK_QUIZ_COUNTDOWN_TIME = 10; // Quick Quiz Category Countdown Time(In seconds)
